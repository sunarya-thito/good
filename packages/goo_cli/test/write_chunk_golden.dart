...
///
/// Run from the goo_cli package root:
///
/// ```
...
/// does *not* move: `goo_cli` checks that its packer still produces these
/// bytes, and `goo` checks that its reader still gets the members back out of
...
/// copy: a real one comes from `lib/goo.generated/asset_key.dart`.
