...
///
/// Shared by `goo build` and `goo assets pack` rather than owned by either:
...
enum AssetMode {
  /// Loose files, exactly as `goo assets compact` wrote them.
  development,

  /// Compressed, encrypted and chunked - see `goo assets pack`.
  release,
}
