...
const GeneratedDeclarations _gameViewTestDeclarations =
    GeneratedDeclarations(
      ...
      collectors: <DeclarationCollector>[
        ...
        DeclarationCollector(_ViewState, _collect$ViewState),
        DeclarationCollector(_ViewGame, _collect$ViewGame),
        DeclarationCollector(_BareViewState, _collect$BareViewState),
        DeclarationCollector(_RendererlessGame, _collect$RendererlessGame),
      ],
