...
const GeneratedDeclarations _render2dTestDeclarations =
    GeneratedDeclarations(
      ...
      collectors: <DeclarationCollector>[
        ...
        DeclarationCollector(_Invisible, _collect$Invisible),
        DeclarationCollector(_Group, _collect$Group),
        DeclarationCollector(_TwoSprite, _collect$TwoSprite),
        DeclarationCollector(_HalfHidden, _collect$HalfHidden),
        DeclarationCollector(_Stack, _collect$Stack),
        DeclarationCollector(_TopLeft, _collect$TopLeft),
        ...
        DeclarationCollector(_UnsizedPanel, _collect$UnsizedPanel),
        DeclarationCollector(_PlainPanel, _collect$PlainPanel),
        DeclarationCollector(_HorizontalBar, _collect$HorizontalBar),
        DeclarationCollector(_SingleCellPanel, _collect$SingleCellPanel),
        DeclarationCollector(_BorderedUntextured, _collect$BorderedUntextured),
        DeclarationCollector(_PivotBody, _collect$PivotBody),
        DeclarationCollector(_SpriteScene, _collect$SpriteScene),
        DeclarationCollector(_RenderState, _collect$RenderState),
        DeclarationCollector(_RenderGame, _collect$RenderGame),
      ],
