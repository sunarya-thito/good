...
part of 'world_transform_test.dart';
...
List<ScannableField> _collect$Plain(Object object) {
  final owner = object as _Plain;
  return <ScannableField>[
    owner.parentFirstChild,
    owner.parentLastChild,
    owner.childParent,
...
const List<Type> _supertypes$Plain = <Type>[
  _Plain,
  EntityStruct,
  Coroutines,
  Animations,
...
const GeneratedDeclarations _worldTransformTestDeclarations =
    GeneratedDeclarations(
      package: 'goo2d/test/world_transform_test.dart',
      collectors: <DeclarationCollector>[
        DeclarationCollector(_Node, _collect$Node, _supertypes$Node),
        DeclarationCollector(_Leaf, _collect$Leaf, _supertypes$Leaf),
        DeclarationCollector(_Plain, _collect$Plain, _supertypes$Plain),
...
/// Installs [_worldTransformTestDeclarations].
///
