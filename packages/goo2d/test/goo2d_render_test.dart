...
class _Billboard extends EntityStruct
  ...
  /// The same key the two textured sprites below name, so this handle and
  /// theirs address one asset - the scene binds by key, not by identity.
  ...
  final front = Sprite.of(texture: tileAsset, width: 2, height: 2, zIndex: 2);
  final middle = Sprite.of(width: 2, height: 2, color: 0xFFFF0000, zIndex: 1);
  final back = Sprite.of(texture: tileAsset, width: 2, height: 2, zIndex: 0);
}
