...
class _Button extends EntityStruct
  ...
  final hitArea = ColliderBody.circle(radius: 20);
...
class _Panel extends EntityStruct
  ...
  final hitArea = ColliderBody.box(halfWidth: 100, halfHeight: 50);
...
class _Zone extends EntityStruct
    with
        ...
        PointerReceiver,
        HoverReceiver {
  final hitArea = ColliderBody.box(halfWidth: 50, halfHeight: 50);
...
class _Satellite extends EntityStruct
    with
        ...
        PointerReceiver,
        HoverReceiver {
  final hitArea = ColliderBody.box(halfWidth: 10, halfHeight: 10, offsetX: 100);
}
...
class _Compound extends EntityStruct
    with
        ...
        PointerReceiver,
        HoverReceiver {
  final near = ColliderBody.circle(radius: 5);
  final far = ColliderBody.circle(radius: 5, offsetY: 150);
}
...
class _Glass extends EntityStruct
  ...
  final hitArea = ColliderBody.box(halfWidth: 30, halfHeight: 30);
...
class _GameState extends GameState<_Game> {
  ...
  @system
  final pointerPickingSystem = PointerPickingSystem();
  @system
  final worldTransformSystem = WorldTransformSystem();
}
