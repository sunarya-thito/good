...
class _Textured extends EntityStruct
  ...
  /// The same key [textured] names, so this handle and the column's address
  /// one asset - the scene binds a handle by its key, not by identity.
...
class _Panel extends EntityStruct
  ...
  /// The same key [frame] names; one asset either way.
