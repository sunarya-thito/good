...
void main() {
  ...
  group('the chunk format', () {
    test('reads a chunk good_cli actually produced', () async {
      // The one test here that is not good agreeing with itself.
      //
      // Everything else in this file is built by `plainChunk` above - good's
      // own idea of the layout, uncompressed and unencrypted. good_cli could
      ...
      //
      // So this opens a chunk good_cli sealed, compressed *and* encrypted,
