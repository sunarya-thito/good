...
const GeneratedDeclarations _gameGamepadTestDeclarations =
    GeneratedDeclarations(
      ...
      collectors: <DeclarationCollector>[
        DeclarationCollector(_PadSystem, _collect$PadSystem),
        DeclarationCollector(_PadGameState, _collect$PadGameState),
        DeclarationCollector(_PadGame, _collect$PadGame),
      ],
