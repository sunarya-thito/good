...
part of 'scene_isolation_test.dart';
...
List<ScannableField> _collect$PhysScene(Object object) {
  final owner = object as _PhysScene;
  return <ScannableField>[
    owner.wall,
    owner.ball,
  ];
...
const List<Type> _supertypes$PhysScene = <Type>[
  _PhysScene,
  SceneStruct,
  Coroutines,
  Scannable,
...
const GeneratedDeclarations _sceneIsolationTestDeclarations =
    GeneratedDeclarations(
      package: 'goo2d_physics_box2d/test/scene_isolation_test.dart',
...
/// Installs [_sceneIsolationTestDeclarations].
///
